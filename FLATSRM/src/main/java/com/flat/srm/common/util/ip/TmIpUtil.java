package com.flat.srm.common.util.ip;
...
public class TmIpUtil {
	...
	/**
	 * 获取用户的IP地址 com.tz.util.ip 方法名：getIpAddr 创建人：xuchengfei 手机号码:15074816437
	...
	/**
	 * 根据IP地址找到你对应城市和省份 com.tz.util.ip 方法名：ipLocation 创建人：xuchengfei
	 * 手机号码:15074816437 时间：2015年9月15日-下午11:21:02
	 * 
	 * @param ip
	 * @return 返回类型：String
	 * @exception
	...
	public static String ipLocation(String ip) {
		String ipLocation = "";
		TmIPSeeker ipSeeker = new TmIPSeeker("qqwry.dat",
				"F:/javaDevelopment/project/jgz_desk/WebRoot/ip/");
	...
	/**
	 * 找到省份 com.tz.util.ip 方法名：ipprovince 创建人：xuchengfei 手机号码:15074816437
	...
	/**
	 * 找到城市 com.tz.util.ip 方法名：ipcity 创建人：xuchengfei 手机号码:15074816437
	...
	/**
	 * 获取省份和城市，传递水晶IP地址库的路径 com.tz.util.ip 方法名：ipLocation 创建人：xuchengfei
	 * 手机号码:15074816437 时间：2015年9月15日-下午11:21:33
	 * 
	 * @param ip
	 * @param path
	 * @return 返回类型：String
	...
	/**
	 * 获取省份和城市，传递水晶IP地址库的路径 com.tz.util.ip 方法名：ipLocation 创建人：xuchengfei
	 * 手机号码:15074816437 时间：2015年9月15日-下午11:22:05
	 * 
	 * @param request
	 * @return 返回类型：String
	 * @exception
